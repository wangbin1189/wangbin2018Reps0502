...
namespace KSI.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Semester'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class SemesterEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static SemesterEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public SemesterEntity() :base("SemesterEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Semester which data should be fetched into this Semester object</param>
		public SemesterEntity(System.Int32 id):base("SemesterEntity")
		{
		...
		public SemesterEntity(System.Int32 id, IPrefetchPath prefetchPathToUse):base("SemesterEntity")
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Semester which data should be fetched into this Semester object</param>
		/// <param name="validator">The custom validator object for this SemesterEntity</param>
		public SemesterEntity(System.Int32 id, IValidator validator):base("SemesterEntity")
		{
		...
		protected SemesterEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Offerings":
					toReturn.Add(Relations.OfferingEntityUsingSemesterId);
					break;
				default:
					break;				
			}
		...
		{
			return new SemesterRelations().GetAllRelations();
		}
		...
		public virtual KSI.CollectionClasses.OfferingCollection GetMultiOfferings(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedOfferings || forceFetch || _alwaysFetchOfferings) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_offerings.GetMultiManyToOne(null, this, null, null, filter);
		...
		/// <param name="id">PK value for Semester which data should be fetched into this Semester object</param>
		/// <param name="validator">The validator object for this SemesterEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_offerings.SetContainingEntityInfo(this, "Semester");
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)SemesterFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return DAOFactory.CreateSemesterDAO();
		}
		...
		{
			return new SemesterEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static SemesterRelations Relations
		{
			get	{ return new SemesterRelations(); }
		}
		...
		{
			get { return new PrefetchPathElement(new KSI.CollectionClasses.OfferingCollection(), (IEntityRelation)GetRelationsForField("Offerings")[0], (int)KSI.EntityType.SemesterEntity, (int)KSI.EntityType.OfferingEntity, 0, null, null, null, "Offerings", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <summary> The EndDate property of the Entity Semester<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Semester"."EndDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): Date, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime EndDate
		{
			get { return (System.DateTime)GetValue((int)SemesterFieldIndex.EndDate, true); }
			set	{ SetValue((int)SemesterFieldIndex.EndDate, value, true); }
		}

		/// <summary> The Id property of the Entity Semester<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Semester"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)SemesterFieldIndex.Id, true); }
			set	{ SetValue((int)SemesterFieldIndex.Id, value, true); }
		}

		/// <summary> The Name property of the Entity Semester<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Semester"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 100<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)SemesterFieldIndex.Name, true); }
			set	{ SetValue((int)SemesterFieldIndex.Name, value, true); }
		}

		/// <summary> The StartDate property of the Entity Semester<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Semester"."StartDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): Date, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime StartDate
		{
			get { return (System.DateTime)GetValue((int)SemesterFieldIndex.StartDate, true); }
			set	{ SetValue((int)SemesterFieldIndex.StartDate, value, true); }
		}
		...
		{ 
			get { return (int)KSI.EntityType.SemesterEntity; }
		}
