...
namespace KSI.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Student'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public StudentEntity(System.Int32 id, IPrefetchPath prefetchPathToUse):base("StudentEntity")
		{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "ClassRegistrations":
					toReturn.Add(Relations.ClassRegistrationEntityUsingStudentId);
					break;
				case "GradeBooks":
					toReturn.Add(Relations.GradeBookEntityUsingStudentId);
					break;
				default:
					break;				
			}
		...
		public virtual KSI.CollectionClasses.ClassRegistrationCollection GetMultiClassRegistrations(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedClassRegistrations || forceFetch || _alwaysFetchClassRegistrations) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_classRegistrations.GetMultiManyToOne(null, this, filter);
		...
		public virtual KSI.CollectionClasses.GradeBookCollection GetMultiGradeBooks(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedGradeBooks || forceFetch || _alwaysFetchGradeBooks) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_gradeBooks.GetMultiManyToOne(null, null, this, null, filter);
		...
		private void InitClassMembers()
		{
			...
			_classRegistrations.SetContainingEntityInfo(this, "Student");

			_gradeBooks = new KSI.CollectionClasses.GradeBookCollection();
			_gradeBooks.SetContainingEntityInfo(this, "Student");
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)StudentFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			get { return new PrefetchPathElement(new KSI.CollectionClasses.ClassRegistrationCollection(), (IEntityRelation)GetRelationsForField("ClassRegistrations")[0], (int)KSI.EntityType.StudentEntity, (int)KSI.EntityType.ClassRegistrationEntity, 0, null, null, null, "ClassRegistrations", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get { return new PrefetchPathElement(new KSI.CollectionClasses.GradeBookCollection(), (IEntityRelation)GetRelationsForField("GradeBooks")[0], (int)KSI.EntityType.StudentEntity, (int)KSI.EntityType.GradeBookEntity, 0, null, null, null, "GradeBooks", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		public virtual System.Int32 Id
		{
			...
			set	{ SetValue((int)StudentFieldIndex.Id, value, true); }
		}

		/// <summary> The IsOnline property of the Entity Student<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Student"."IsOnline"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsOnline
		{
			get { return (System.Boolean)GetValue((int)StudentFieldIndex.IsOnline, true); }
			set	{ SetValue((int)StudentFieldIndex.IsOnline, value, true); }
		}

		/// <summary> The LastName property of the Entity Student<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Student"."LastName"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 100<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String LastName
		{
			get { return (System.String)GetValue((int)StudentFieldIndex.LastName, true); }
			set	{ SetValue((int)StudentFieldIndex.LastName, value, true); }
		}

		/// <summary> The Status property of the Entity Student<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Student"."Status"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 100<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Status
		{
			get { return (System.String)GetValue((int)StudentFieldIndex.Status, true); }
			set	{ SetValue((int)StudentFieldIndex.Status, value, true); }
		}

		/// <summary> The StudentId property of the Entity Student<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Student"."StudentId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 StudentId
		{
			get { return (System.Int32)GetValue((int)StudentFieldIndex.StudentId, true); }
			set	{ SetValue((int)StudentFieldIndex.StudentId, value, true); }
		}
		...
		{ 
			get { return (int)KSI.EntityType.StudentEntity; }
		}
