...
namespace KSI.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'OfferingSchedule'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class OfferingScheduleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static OfferingScheduleEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public OfferingScheduleEntity() :base("OfferingScheduleEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="id">PK value for OfferingSchedule which data should be fetched into this OfferingSchedule object</param>
		public OfferingScheduleEntity(System.Int32 id):base("OfferingScheduleEntity")
		{
		...
		public OfferingScheduleEntity(System.Int32 id, IPrefetchPath prefetchPathToUse):base("OfferingScheduleEntity")
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for OfferingSchedule which data should be fetched into this OfferingSchedule object</param>
		/// <param name="validator">The custom validator object for this OfferingScheduleEntity</param>
		public OfferingScheduleEntity(System.Int32 id, IValidator validator):base("OfferingScheduleEntity")
		{
		...
		{
			switch((OfferingScheduleFieldIndex)fieldIndex)
			{
				case OfferingScheduleFieldIndex.OfferingId:
		...
		{
			return new OfferingScheduleRelations().GetAllRelations();
		}
		...
		/// <param name="id">PK value for OfferingSchedule which data should be fetched into this OfferingSchedule object</param>
		/// <param name="validator">The validator object for this OfferingScheduleEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("Weekday", fieldHashtable);
		}
		#endregion
		...
		{
			this.PerformDesetupSyncRelatedEntity( _offering, new PropertyChangedEventHandler( OnOfferingPropertyChanged ), "Offering", KSI.RelationClasses.StaticOfferingScheduleRelations.OfferingEntityUsingOfferingIdStatic, true, signalRelatedEntity, "OfferingSchedules", resetFKFields, new int[] { (int)OfferingScheduleFieldIndex.OfferingId } );		
			_offering = null;
		}
		...
		private void SetupSyncOffering(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _offering, new PropertyChangedEventHandler( OnOfferingPropertyChanged ), "Offering", KSI.RelationClasses.StaticOfferingScheduleRelations.OfferingEntityUsingOfferingIdStatic, true, ref _alreadyFetchedOffering, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)OfferingScheduleFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return new OfferingScheduleEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static OfferingScheduleRelations Relations
		{
			get	{ return new OfferingScheduleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new KSI.CollectionClasses.OfferingCollection(), (IEntityRelation)GetRelationsForField("Offering")[0], (int)KSI.EntityType.OfferingScheduleEntity, (int)KSI.EntityType.OfferingEntity, 0, null, null, null, "Offering", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The EndTime property of the Entity OfferingSchedule<br/><br/></summary>
		/// <remarks>Mapped on  table field: "OfferingSchedule"."EndTime"<br/>
		...
		{
			get { return (System.TimeSpan)GetValue((int)OfferingScheduleFieldIndex.EndTime, true); }
			set	{ SetValue((int)OfferingScheduleFieldIndex.EndTime, value, true); }
		}

		/// <summary> The Id property of the Entity OfferingSchedule<br/><br/></summary>
		/// <remarks>Mapped on  table field: "OfferingSchedule"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)OfferingScheduleFieldIndex.Id, true); }
			set	{ SetValue((int)OfferingScheduleFieldIndex.Id, value, true); }
		}

		/// <summary> The OfferingId property of the Entity OfferingSchedule<br/><br/></summary>
		/// <remarks>Mapped on  table field: "OfferingSchedule"."OfferingId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 OfferingId
		{
			get { return (System.Int32)GetValue((int)OfferingScheduleFieldIndex.OfferingId, true); }
			set	{ SetValue((int)OfferingScheduleFieldIndex.OfferingId, value, true); }
		}

		/// <summary> The StartTime property of the Entity OfferingSchedule<br/><br/></summary>
		/// <remarks>Mapped on  table field: "OfferingSchedule"."StartTime"<br/>
		/// Table field type characteristics (type, precision, scale, length): Time, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.TimeSpan StartTime
		{
			get { return (System.TimeSpan)GetValue((int)OfferingScheduleFieldIndex.StartTime, true); }
			set	{ SetValue((int)OfferingScheduleFieldIndex.StartTime, value, true); }
		}

		/// <summary> The Weekday property of the Entity OfferingSchedule<br/><br/></summary>
		/// <remarks>Mapped on  table field: "OfferingSchedule"."Weekday"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Weekday
		{
			get { return (System.String)GetValue((int)OfferingScheduleFieldIndex.Weekday, true); }
			set	{ SetValue((int)OfferingScheduleFieldIndex.Weekday, value, true); }
		}
		...
		public virtual OfferingEntity Offering
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "OfferingSchedules", "Offering", _offering, true); 
				}
			}
		}
		...
		{ 
			get { return (int)KSI.EntityType.OfferingScheduleEntity; }
		}
