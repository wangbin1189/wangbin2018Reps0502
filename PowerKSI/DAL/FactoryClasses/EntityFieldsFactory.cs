...
namespace KSI.FactoryClasses
{
	...
	{
		private static readonly Dictionary<KSI.EntityType, string> _entityTypeNamesCache = new Dictionary<KSI.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(KSI.EntityType value in Enum.GetValues(typeof(KSI.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(KSI.EntityType), value));
			}
		}	
